...
### Lesson
```
In this exercise I was able to learn the many cosiderations a data analyst has to make in order to work with the given data seemlessly.
...
The Blogpost can be found here:<br/>
